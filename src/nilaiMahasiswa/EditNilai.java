...
public class EditNilai extends javax.swing.JFrame {
    ...
    private ListNilai list;

    public Statement st;
    public ResultSet rs;
    Connection conn = Conn.Connect();

    public EditNilai(ListNilai list) {
        this.list = list;
    ...
    private void buttonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveActionPerformed
        try {
            ...
            if (!textNIM.getText().trim().isEmpty() && !textNama.getText().trim().isEmpty() && !textTugas.getText().trim().isEmpty() && !textKuis.getText().trim().isEmpty()
                ...
                st.executeUpdate("UPDATE nilai SET "
                        + "nim = '" + textNIM.getText() + "',"
                        + "nama = '" + textNama.getText() + "',"
                        + "tugas = '" + textTugas.getText() + "',"
                        + "kuis = '" + textKuis.getText() + "',"
                        + "uts = '" + textUTS.getText() + "',"
                        + "uas = '" + textUAS.getText() + "' WHERE nim = " + list.editNIM);
    ...
    public void initTextValue() {
        try {
            String sql = "select * from nilai where nim = %s";
            sql = String.format(sql, list.editNIM);
            ...
            if (rs.next()) {
                ...
                textTugas.setText(rs.getString("tugas"));
                textKuis.setText(rs.getString("kuis"));
                textUTS.setText(rs.getString("uts"));
                textUAS.setText(rs.getString("uas"));
            ...
            System.out.println(e.getMessage());
            JOptionPane.showMessageDialog(null, "Data Nilai gagal terambil!");
        }
    }
